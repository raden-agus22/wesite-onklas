...
<nav class="navbarr" style="margin-bottom: 10px;">
...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="tab-content">
        ...
        <div id="alur" class="tab-pane">
          ...
          <p>b. Kolom yang berbintang (*) wajib diisi, jika belum ada data, isi dengan paduan 3 digit angka
            (008/808/977)
          </p>
          ...
          <p>e. Calon siswa baru membayar biaya pendaftaran sebesar Rp. 100.000,00 melalui transfer BRI No.
            002301001299305
            a.n. SMK TI ANNAJIYAH BAHRUL ULUM</p>
          <p>f. Calon siswa baru melakukan konfirmasi pembayaran melalui SMS/telepon/WA ke nomor 085-707-987-987
            dengan
          ...
          <p>b. Melakukan pembayaran administrasi Daftar Ulang bisa dilakukan melalui transfer ke rekening sekolah:
            BRI No.
            002301001299305 a.n. SMK TI ANNAJIYAH BAHRUL ULUM</p>
          <p>c. Konfirmasi transfer pembayaran melalui SMS/telepon/WA ke nomor 085-707-987-987 dengan menyebutkan nama
            calon
            ...
            <div class="tab-content" style="margin-bottom: 50px;">
              <div id="siswa" class="tab-pane fade in active">
                <div class="row">
                  <div class="col-md-6 mb">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" autoComplete="off" required
                  ...
                  <div class="col-md-6 mb">
                    ...
                    <input type="date" class="form-control" id="exampleFormControlInput1" autoComplete="off" required
              ...
              <div id="sekolah" class="tab-pane fade in">
                ...
                <button type="submit" class="btn btn-succes" style="margin-top: 15px;"><i class="fa fa-save"></i>
                   <a href="javascript:void" data-toggle="modal" data-target="#exampleModal11"> Daftar Sekarang</a></button>
              </div>
            </div>
          </form>
        </div>
  ...
  <div class="col-md-3">
    <div class="col-md-12">
      ...
      <div class="card1">
        <h5>Hubungi lewat email kami</h5>
        <h5><a href="mailto:sekolah@onklas.id">sekolah@onklas.id</a></h5><br>
        <h5>Call center</h5>
        <h5><a href="whatsapp://send?text=Hello&phone=0822311712123">0822311712123 / Klik untuk menghubungi</a></h5>
        <h5>Panitia PPDB</h5>
        <h5><a href="whatsapp://send?text=Hello&phone=0822311712123">0822311712123 / Klik untuk menghubungi</a></h5>
      </div>
    </div>
...
<div class="modal fade" id="berhasil-keluar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary"><a href="index.php">Close</a></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-secondary"><a href="ppdb.php">Close</a></button>
      </div>
    </div>
  </div>
</div>
